...
module.exports = function(intentRequest) {
  ...
  const motivationArr = data;
  const motivationIndex = Math.floor(Math.random() * motivationArr.length);
  const randomMotivation = motivationArr[motivationIndex];
  console.log(`MotivateUser intentRequest.invocationSource=${intentRequest.invocationSource}`);
  if (source === 'DialogCodeHook') {
    const fullfilmentResult = buildFulfilmentResult('Fulfilled', randomMotivation);
